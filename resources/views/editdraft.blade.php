    ...
    <section class="container mt-4" style="padding: 0px 15%">
        ...
        <form action="/draftedit/update/{{ $article->id }}" method="post" enctype="multipart/form-data">
            ...
            <section class="container mt-4 mb-5" style="padding: 0px 15%">
                <section class="row p-0 m-0" >
                    <button class="col-6 p-2 eye-hover border-0" type="submit"  name="submitType" value="draft">
                        <h1 class="fs-1 text-start text-white ms-1 text-uppercase hit-border m-0 p-0" style="line-height: 30px; font-family: poppins-bold; color: #2252AB; " >
                            SAVE <br>
                            CHANGE
                        </h1>
                    </button>
                    <button class="col-5 p-2 eye-hover border-0" type="submit" name="submitType" value="submit">
                        <h1 class="fs-1 text-start text-white ms-1 text-uppercase hit-border m-0 p-0" style="line-height: 30px; font-family: poppins-bold; color: #2252AB; " >
                            PUBLISH <br>
                            ARTICLE
                        </h1>
                    </button>
                    <button class="col-1 p-2 bg-danger text-white eye-hover border-0" type="submit" name="submitType" value="trash" style="border: 2px solid red;">
