...
<body>
    <div class="container-fluid vh-100 p-0 m-0" style="overflow-y: auto; z-index: 100; ">
        <nav class="navbar navbar-light bg-light w-100 pe-2" style="position: fixed">
            <div class="container d-flex justify-content-start align-items-center " style="padding: 0px 200px" >
                ...
                <div>
                    <div class="h5 p-0 m-0" style="font-family: poppins-bold" > {{ $article->title }}</div>
                    <div style="font-size: 12px" class=" p-0 m-0" style="font-family: poppins" >Ditulis Oleh {{ $article->author }}</div>
                </div>
            </div>
        </nav>
        <div class="container" style="margin-top: 5%; padding: 0px 200px" >
            ...
            <div class="mb-5" style="min-height: 50vh; font-size: 12px' z-index: 1;" >
                {{-- {{ $article->content }} --}}
                {!! $article->content !!}
            </div>
        </div>
