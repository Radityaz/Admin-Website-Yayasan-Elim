...
<body style="overflow: hidden" >
      <section class="container-fluid">
        <section class="row vh-100">
            ...
            <form action="/login" method="get" class="col-6 p-2 d-flex flex-column justify-content-between">
                @csrf
                <div class="w-100">
                    ...
                    <p class="w-25" style="font-size: 10px">
                        Easily log in into an account with our simple signup process.
                    </p>
            
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-0" style="height: 40px">
                                <input class="w-100 h-100 ps-3" style="font-size: 13px; outline: 2px solid black" name="useremail" placeholder="Enter Username or Email..." type="text" required>
                                <p style="font-size: 13px"  class="text-danger {{ session('error') == 'Invalid username or password' ? 'd-block' : 'd-none'  }}" >Username Invalid</p>
                            </div>
                            <div class="col-11 p-0 mt-4" style="height: 40px">
                                <input class="w-100 h-100 ps-3"  id="password" style="font-size: 13px; outline: 2px solid black" name="password" placeholder="Enter Password..." type="password" required>
                                <p style="font-size: 13px"  class="text-danger {{ session('error') == 'Invalid username or password' ? 'd-block' : 'd-none'  }}" >Password Invalid</p>
                            </div>
                    ...
                    <div class="d-flex align-items-center mt-4">
                        <a style="font-size: 13px;" href="/createacc">Dont have account?, click here</a>
                    </div>
                </div>
                <button type="submit" class="text-decoration-none button-hover-signup w-100 border-0 d-flex align-items-center justify-content-between">
                    <h1 class="text-uppercase hit-border-bottom text-white" style="font-family: poppins-bold;">Sign Up</h1>
    ...
    <script src="/js/script.jsb"></script>
</body>
</html>