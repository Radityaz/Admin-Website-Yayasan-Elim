                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-0" style="height:40px" >
                                <input class="w-100 h-100 ps-3" style="font-size: 13px; outline: 2px solid black" placeholder="Enter Username..." type="text">
                            </div>
                            <div class="col-11 p-0 mt-4" style="height:40px" >
                                <input class="w-100 h-100 ps-3" style="font-size: 13px; outline: 2px solid black" placeholder="Enter Password..." type="text">
                            </div>
                            <div class="col-1 p-0 mt-4">
                                <button class="w-100 h-100 border-0 eye-hover" >
                                    <img src="/image/eye-white.png" height="20" alt="" srcset="">
                                </button>
                            </div>
                        </div>
                    </div>
